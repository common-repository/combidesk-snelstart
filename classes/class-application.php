...
class Application {
	...
	public function __construct() {
		$this->plugin_name         = 'combidesk-snelstart';
		$this->plugin_product_name = __( 'SnelStart', $this->plugin_name );
		...
		$this->description = __( 'Synchronize your WooCommerce orders automatically to SnelStart', $this->plugin_name );
		$this->run();
	}
	...
	public function woo_hpos_compatibility() {
		if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
			\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', 'combidesk-snelstart/combidesk-snelstart.php', true );
		}
	}
	...
	function add_combidesk_page() {
		...
		$menu_slug  = 'combidesk-snelstart-settings';
	...
	function combidesk_settings() {
		...
		echo '
		  ...
		  <form class="combidesk__cta-form" action="https://combidesk.com/combipackageinstall/woocommerce-snelstart " method="GET" target="_BLANK">
		  ...
		  <form class="combidesk__cta-form" action="https://www.snelstart.nl/tijdbesparen/v2" method="GET" target="_BLANK">
	...
	function load_combidesk_plugin_style( $hook ) {
		if ( $hook != 'toplevel_page_combidesk-snelstart-settings' ) {
			return;
		}
